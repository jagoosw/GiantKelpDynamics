...
# with 10m spacing normal version takes 89ms for 1s timestep and speed takes 10ms
spacing = 100.
...
for kinematics in (UtterDenny(), UtterDennySpeed())
    @testset "$(typeof(kinematics)) movement" begin
        kelp = GiantKelp(; grid,
